...
// func NewDataBaseServiceCasbin(i *do.Injector) (*DataBaseServiceCasbin, error) {
// 	dbServiceCasbin := &DataBaseServiceCasbin{
...
// type DataBaseServiceCasbin struct {
// 	client   *ent.Client
// 	ctx      context.Context
// 	filtered bool
// }
...
// func (a *DataBaseServiceCasbin) LoadPolicy(model model.Model) error {
...
// func (a *DataBaseServiceCasbin) LoadFilteredPolicy(model model.Model, f interface{}) error {
...
// func (a *DataBaseServiceCasbin) IsFiltered() bool {
// 	return a.filtered
// }

// // SavePolicy saves all policy rules to the storage.
// func (a *DataBaseServiceCasbin) SavePolicy(model model.Model) error {
...
// func (a *DataBaseServiceCasbin) AddPolicy(sec string, ptype string, rule []string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// // This is part of the Auto-Save feature.
// func (a *DataBaseServiceCasbin) RemovePolicy(sec string, ptype string, rule []string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// // This is part of the Auto-Save feature.
// func (a *DataBaseServiceCasbin) RemoveFilteredPolicy(sec string, ptype string, fieldIndex int, fieldValues ...string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// // This is part of the Auto-Save feature.
// func (a *DataBaseServiceCasbin) AddPolicies(sec string, ptype string, rules [][]string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// // This is part of the Auto-Save feature.
// func (a *DataBaseServiceCasbin) RemovePolicies(sec string, ptype string, rules [][]string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// func (a *DataBaseServiceCasbin) WithTx(fn func(tx *ent.Tx) error) error {
...
// func (a *DataBaseServiceCasbin) toInstance(ptype string, rule []string) *ent.CasbinRule {
...
// func (a *DataBaseServiceCasbin) savePolicyLine(tx *ent.Tx, ptype string, rule []string) *ent.CasbinRuleCreate {
...
// // This is part of the Auto-Save feature.
// func (a *DataBaseServiceCasbin) UpdatePolicy(sec string, ptype string, oldRule, newPolicy []string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// func (a *DataBaseServiceCasbin) UpdatePolicies(sec string, ptype string, oldRules, newRules [][]string) error {
// 	return a.WithTx(func(tx *ent.Tx) error {
...
// func (a *DataBaseServiceCasbin) UpdateFilteredPolicies(sec string, ptype string, newPolicies [][]string, fieldIndex int, fieldValues ...string) ([][]string, error) {
...
// func (a *DataBaseServiceCasbin) createPolicies(tx *ent.Tx, ptype string, policies [][]string) error {
// 	lines := make([]*ent.CasbinRuleCreate, 0)
// 	for _, policy := range policies {
// 		lines = append(lines, a.savePolicyLine(tx, ptype, policy))
// 	}
