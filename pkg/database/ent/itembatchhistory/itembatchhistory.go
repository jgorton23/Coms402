...
const (
	// Label holds the string label denoting the itembatchhistory type in the database.
	Label = "item_batch_history"
	...
	// Table holds the table name of the itembatchhistory in the database.
	Table = "item_batch_history"
)

// Columns holds all SQL columns for itembatchhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("itembatchhistory: invalid enum value for operation field: %q", o)
	}
}
