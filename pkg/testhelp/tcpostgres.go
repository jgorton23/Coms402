...
// StarPostgresContainer creates an instance of the postgres container type
func StarPostgresContainer(ctx context.Context, opts ...PostgresContainerOption) (*PostgresContainer, error) {
